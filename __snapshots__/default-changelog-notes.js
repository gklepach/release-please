...
exports['DefaultChangelogNotes buildNotes should link JIRA-like keys in Others using tracker-url and tracker-list 1'] = `
## [1.2.3](https://github.com/googleapis/java-asset/compare/v1.2.2...v1.2.3) (1983-10-10)

### Others

* [INFRA-893](https://linear.app/aiphoria-ai/issue/INFRA-893): test commit name bla bla ([sha4](https://github.com/googleapis/java-asset/commit/sha4))
* [INFRA-893](https://linear.app/aiphoria-ai/issue/INFRA-893): test commit name bla bla ([sha5](https://github.com/googleapis/java-asset/commit/sha5))
* [INFRA-893](https://linear.app/aiphoria-ai/issue/INFRA-893): test commit name bla bla ([sha6](https://github.com/googleapis/java-asset/commit/sha6))
`
